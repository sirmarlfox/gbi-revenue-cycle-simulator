  ...
  const renderStepContent = () => {
    switch (step) {
      ...
      case ProcessStep.Complete:
        return (
          <div className="flex flex-col items-center justify-center h-full text-fintech-text animate-fade-in-up">
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-fintech-bg text-fintech-text font-sans">
      ...
      <main className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-1/3 bg-fintech-bg border-r border-fintech-border shadow-2xl z-10 overflow-y-auto hidden md:block">
          <ProcessMap currentStep={step} />
        </aside>

        {/* Right Panel: Workspace */}
        <section className="w-full md:w-2/3 bg-fintech-bg relative overflow-hidden flex flex-col bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-fintech-card to-fintech-bg">
           <div className="flex-1 overflow-y-auto p-4 md:p-8 doc-scroll">
